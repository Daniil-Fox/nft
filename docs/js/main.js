...
new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.creators__slider', {
  slidesPerView: 'auto',
  spaceBetween: 46
});
window.addEventListener('DOMContentLoaded', () => {
  ...
  resizableSwiper('(max-width: 1025px)', '.popular__slider', {
    slidesPerView: 'auto',
    spaceBetween: 12
  });
  resizableSwiper('(max-width: 768px)', '.journal__slider', {
    slidesPerView: 'auto',
    spaceBetween: 12
  });
});
